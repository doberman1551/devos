...
`
    ...
    return (
        <Container>
            ...
            <h2> What is it?</h2>
            <TextArea>
            <b>Building a technology service business is hard... </b> <br></br> Lancerlot is your loyal companion to save time.<br></br> It is an all-in-one Notion dashboard to help you with sales, marketing, projects and  finance. 
            <br></br>
